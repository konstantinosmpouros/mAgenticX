...
import { saveCookieConsent } from "@/shared/lib/cookieConsentStorage";
          ...
          <div className="flex items-start gap-3 sm:items-center">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-xs leading-relaxed text-muted-foreground">
                mAgenticX uses strictly necessary session cookies for authentication and security —
                no tracking or ads. By continuing you agree to our{" "}
                <Link
                  to="/privacy"
