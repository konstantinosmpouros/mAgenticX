...
import type { PlanItemStatus, PlanSnapshot } from "@/lib/types";
        ...
        <div className="relative flex flex-col">
          ...
          >
            ...
            <div className="flex shrink-0 items-center gap-2">
              <div className="hidden items-center gap-2 rounded-full border border-border bg-secondary/45 px-2.5 py-1 transition-colors duration-500 ease-out sm:flex">
