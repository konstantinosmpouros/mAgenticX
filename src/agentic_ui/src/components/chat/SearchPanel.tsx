  ...
  return (
    <div className="fixed inset-0 z-50 pointer-events-none">
      <div
        ref={panelRef}
        className={cn(
          "pointer-events-auto fixed left-1/2 top-1/2 flex max-h-[min(38rem,calc(100svh-2rem))] w-[min(34rem,calc(100vw-2rem))] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-lg border border-border/70 bg-background/95 text-foreground shadow-2xl backdrop-blur-xl"
        )}
      >
