          ...
          <div className="grid gap-4 md:grid-cols-2">
            {HELP_CARDS.map((card) =>
              card.href ? (
                ...
                <div key={card.title} className="rounded-[1.4rem] bg-muted/30 p-5">
                  <h3 className="text-sm font-semibold text-foreground">{card.title}</h3>
                  <p className="mt-2 text-sm text-muted-foreground">{card.desc}</p>
                </div>
              ),
        ...
        >
          <SoftPanel className="divide-y divide-border/35 overflow-hidden">
            ...
            <div className="flex items-center gap-3 px-4 py-4">
              ...
              <div>
                <p className="text-sm font-semibold text-foreground">
                  {archivedConversations.length} archived conversation
            ...
            <div className="flex items-center gap-3 px-4 py-4">
              ...
              <div>
                <p className="text-sm font-semibold text-foreground">Theme: {currentTheme}</p>
                <p className="text-sm text-muted-foreground">
