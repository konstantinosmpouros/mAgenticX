...
class ReflectionOutput(BaseModel):
    ...
    reflection: Optional[str] = Field(
        None,
        description=(
            "Robust and meaningful critique provided only if 'requires_additional_retrieval' is True. ",
            "This should thoroughly evaluate the answer's accuracy, theological consistency, coherence, and completeness. ",
            "Clearly outline specific deficiencies, contradictions, or missing critical information that necessitate additional retrieval.",
        ),
    )
