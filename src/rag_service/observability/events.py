...
class EventLogger:
    ...
    def log(self, level: int, event: str, message: str | None = None, *, exc_info: bool = False, **fields: Any) -> None:
        self._logger.log(
            level,
    ...
    def warning(self, event: str, message: str | None = None, *, exc_info: bool = False, **fields: Any) -> None:
        self.log(logging.WARNING, event, message, exc_info=exc_info, **fields)
