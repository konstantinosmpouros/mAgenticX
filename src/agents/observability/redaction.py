...
_DROP_FIELD_NAMES = {"username", "title", "file_name", "filename", "message_content", "content", "history", "messages"}
_HASHED_CONTEXT_FIELDS = {"client_ip", "session_id"}
_HASHED_FIELD_NAMES = {"client_ip", "session_id"}
_MAX_STRING_LENGTH = 256
_REDACTION_SECRET = configs.logging.redaction_secret.encode("utf-8")
