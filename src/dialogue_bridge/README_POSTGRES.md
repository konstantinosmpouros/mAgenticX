...
- Persist seeded agent metadata plus runtime inserts for users, conversations, messages, attachments, and blobs.
...
- `seed_agents` populates the core agent roster the first time the service runs.
