...
class ProxySettings(BaseSettings):
    ...
    cidrs: str = Field("", validation_alias="TRUSTED_PROXY_CIDRS")
    trusted_networks: tuple[ProxyNetwork, ...] = Field(default=())
    ...
    def _parse_networks(self) -> "ProxySettings":
        ...
        for item in self.cidrs.split(","):
            ...
            try:
                ...
                continue
        object.__setattr__(self, "trusted_networks", tuple(networks))
        return self
