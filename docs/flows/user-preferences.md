...
| Personalization runtime (agents) | [src/agents/harness/personalization/personalization.py](../../src/agents/harness/personalization/personalization.py) | Preset registry + directives, `parse_personalization()` (fail-closed), `build_personalization_prompt()` |
