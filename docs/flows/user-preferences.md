...
| Personalization runtime (agents) | [src/agents/harness/personalization.py](../../src/agents/harness/personalization.py) | Preset registry + directives, `parse_personalization()` (fail-closed), `build_personalization_prompt()` |
