...
| Per-(user, agent) tool prefs | [src/dialogue_bridge/utils/agent_tool_prefs.py](../../src/dialogue_bridge/utils/agent_tool_prefs.py) | `_tool_prefs_path` 44-45, effective-set formula 13-19, `read_tool_prefs` 55-77 |
