...
| Block + timeline types | [src/agentic_ui/src/shared/lib/types.ts](../../src/agentic_ui/src/shared/lib/types.ts) | `SubagentBlock.blocks` (`:551`) to widen, `ArtifactBlock` (`:559`), `TimelineBlock` union (`:570`), `TimelineFoldIndexes` (`:580`), `RunTimeline` (`:600`) |
...
| Transport + contracts | [src/agentic_ui/src/shared/lib/api.ts](../../src/agentic_ui/src/shared/lib/api.ts) · [http.ts](../../src/agentic_ui/src/shared/lib/http.ts) | `startInference` — the only path a chart action may take; components never fetch |
</content>
</invoke>
