...
| Native-tool registry | [harness/tools/registry.py](../../src/agents/harness/tools/registry.py) | `NativeToolDef` (`auto_attach=False` slot), `hitl_default` is decorative |
| Agent→bridge tool pattern | [harness/tools/memory_search.py](../../src/agents/harness/tools/memory_search.py) | per-run closure over `user_id`, `internal_service_headers()` |
| New native tools | `src/agents/harness/tools/email_*.py` *(new)* | envelope + sanitizer at the boundary |
| Agents→bridge URL settings | [agents/core/settings.py](../../src/agents/core/settings.py) | `BridgeSettings`, `memory_search_url` |
| HITL gate producers | [deep_agents/omni_agent/\_\_init\_\_.py](../../src/agents/deep_agents/omni_agent/__init__.py) · [agents_seed/omni-yaml-v1/agent.yaml](../../src/agents/harness/agents_seed/omni-yaml-v1/agent.yaml) | `HITL_GATED_TOOLS`, the `hitl:` block |
| HITL spec field + floor | [harness/abstractions/agent_spec.py](../../src/agents/harness/abstractions/agent_spec.py) | `hitl: dict[str, bool]` |
...
| Retention sweeper idioms | [harness/filesystem/retention.py](../../src/agents/harness/filesystem/retention.py) | containment refusal, bounded pass, activity grace |
...
| Decoys to retire or retarget | [mcp_gateway/mcp_catalog.yaml](../../src/mcp_gateway/mcp_catalog.yaml) · [skill_registry/registry/automation/](../../src/agents/harness/skill_registry/registry/automation/) | `gmail-mcp` entry, `gws-gmail*` skill docs |
