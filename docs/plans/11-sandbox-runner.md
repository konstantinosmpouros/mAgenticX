...
**`execute` is a reserved tool name.** `RESERVED_DEEPAGENT_TOOL_NAMES` at [`src/agents/runtime/abstractions/deep_agent.py:37-58`](../../src/agents/runtime/abstractions/deep_agent.py) includes `"execute"` at `:48`, so a live MCP tool named `execute` is dropped rather than smuggled in under the framework's name.
...
| Permissions applied to every deep agent | [src/agents/runtime/abstractions/deep_agent.py](../../src/agents/runtime/abstractions/deep_agent.py) | `build_deep_agent` `:387`, `permissions=list(WORKSPACE_WRITE_DENY)` `:465` |
| `execute` as a reserved name | [src/agents/runtime/abstractions/deep_agent.py](../../src/agents/runtime/abstractions/deep_agent.py) | `RESERVED_DEEPAGENT_TOOL_NAMES` `:37-58`, `"execute"` `:48` |
...
| HITL gate, declarative | [src/agents/agents_seed/omni-yaml-v1/agent.yaml](../../src/agents/agents_seed/omni-yaml-v1/agent.yaml) · [runtime/abstractions/agent_spec.py](../../src/agents/runtime/abstractions/agent_spec.py) | `hitl:` `:37-41` · `hitl` field `:145`, wired at [yaml_agent.py:158](../../src/agents/runtime/abstractions/yaml_agent.py) |
